...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 24 24" className="size-4" aria-hidden="true">
      ...
      <path
        fill="#EA4335"
        d="M12 4.77c1.76 0 3.35.61 4.6 1.8l3.44-3.44C17.95 1.19 15.24 0 12 0 7.31 0 3.25 2.7 1.27 6.63l4 3.1C6.22 6.88 8.87 4.77 12 4.77z"
      />
    </svg>
  )
}
...
export function GoogleSignInButton() {
  ...
  async function handleClick() {
    ...
    // On success the browser is redirected to Google; no further client action needed.
  }
